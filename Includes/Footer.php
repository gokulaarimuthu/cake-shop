...
<footer class="footer-group">
    <div class="footer">
        ...
        <div class="contact-links">
            <span class="phone"><i class="fas fa-phone-square-alt"></i> +91 7904530184</span>
            <span class="address">Vellore Tamil Nadu</span>
        </div>
        ...
        <div class="copyright">
            <span class="copyright-text">&#169; <?php echo date("Y"); ?> Copyrights: Gokul</span>
        </div>
    </div>  
</footer>